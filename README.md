...
| --- | --- | --- | --- |
| [indoor-navigation](indoor-navigation/) | SLAM builds a map, Nav2 drives clicked goals, fully in sim, viewer bundled | ROS 2 Jazzy · Nav2 · Gazebo · Pixi/RoboStack or Docker | Apple Silicon: `make native-setup && make demo-native`; portable: `make build && make demo` |
