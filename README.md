...
| --- | --- | --- | --- |
| [robot-navigation](robot-navigation/) | SLAM builds a map, Nav2 drives clicked goals, fully in sim, viewer bundled | ROS 2 Jazzy · Nav2 · Gazebo · Pixi/RoboStack or Docker | `cd robot-navigation && ./app run` |
| [diffusion-policy-pusht](diffusion-policy-pusht/) | Run a published PushT Diffusion Policy and compare repeatable seeded layouts | LeRobot · Diffusion Policy · gym-pusht · uv (MPS) · Gradio + Rerun | `cd diffusion-policy-pusht && ./app run` |
| [vla-pick-and-place](vla-pick-and-place/) | Language-conditioned pick-and-place with SmolVLA on a simulated SO-101 arm (pipeline proven end-to-end; full-training policy pending) | LeRobot · SmolVLA · MuJoCo · uv (MPS) + HF Jobs | `cd vla-pick-and-place && ./app run` |
...
| [lego-powered-up-teleop](lego-powered-up-teleop/) | Drive a two-motor LEGO differential-drive robot from a native directional pad or Stadia gamepad over Bluetooth | Pybricks · Bleak · Pygame · uv | `cd lego-powered-up-teleop && ./app run` |
