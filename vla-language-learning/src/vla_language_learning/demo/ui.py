...
from vla_language_learning.config import DEMO_CHECKPOINT, TASK

APP_ID = "vla_language_learning_demo"
...
def build_ui(get_runner) -> gr.Blocks:
    ...
    with gr.Blocks(title="vla-language-learning — robium live demo") as blocks:
