...
Simplify indoor-navigation to one larger supported robot and two useful environments. TurtleBot3 Waffle Pi becomes the only robot. The control panel exposes only House and Warehouse, with House selected at startup.
