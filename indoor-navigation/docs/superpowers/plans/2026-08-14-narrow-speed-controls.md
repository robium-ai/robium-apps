...
- [ ] **Step 3: Add the adapter method and slider markup**
...
- [ ] **Step 3: Simplify markup, add compact CSS, and update layout**
...
**Files:**
- Modify: `indoor-navigation/docs/superpowers/plans/2026-08-14-narrow-speed-controls.md` (checkboxes only)

**Interfaces:**
- Consumes: packaged `.foxe`, fingerprinted preinstall bootstrap, mapping Docker profile.
- Produces: verified narrow default panel.

- [ ] **Step 1: Run extension and host gates**
...
- [ ] **Step 2: Build and inspect the real Lichtblick view**
...
- [ ] **Step 3: Run the isolated navigation smoke**
...
Commit as `feat(indoor-navigation): add compact speed controls`.
