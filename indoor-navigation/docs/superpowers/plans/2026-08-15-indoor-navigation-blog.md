# Indoor Navigation Blog Refresh Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Replace the old indoor-navigation engineering story with an original tutorial-style blog post that matches the current application.
...
**Files:**
- Modify: `indoor-navigation/docs/case-study.md`

**Interfaces:**
- Consumes: current commands from `indoor-navigation/Makefile`, application behavior from `indoor-navigation/README.md`, and frontmatter ingestion from `robium-website/scripts/fetch-articles.mjs`
