...
| --- | --- | --- | --- | --- | --- | --- |
| [indoor-navigation](indoor-navigation/) | Classical ROS navigation | ROS 2 Jazzy + Nav2 + slam_toolbox | Gazebo Harmonic; four selectable indoor worlds including pinned AWS Furnished House | Pixi/RoboStack (macOS arm64) + Docker | Native Gazebo + bundled Lichtblick + reusable Robot Control `.foxe` | Extension, IDLE/mapping/localization, four-world sensors, and two-goal smoke verified 2026-08-14 |
