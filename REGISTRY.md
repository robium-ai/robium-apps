...
| [vla-pick-and-place](vla-pick-and-place/) | Language-conditioned VLA (experimental) | pinned LeRobot v0.4.4 + official Pi0.5 LIBERO checkpoint | LIBERO-Goal task 8 (Franka Panda) | uv + Python 3.10; fake local fixtures; pinned Linux/amd64 CUDA image for RunPod | capability-scoped Gradio simulator frames | Local/clean-env 14 tests, fake rollout, Gradio stream, protected CPU container lifecycle passed 2026-08-23; paid preflight blocked on balance, image, template/cost center, and model volume |
