...
| [vla-pick-and-place](vla-pick-and-place/) | Language-conditioned VLA (experimental) | pinned LeRobot v0.4.4 + official Pi0.5 LIBERO checkpoint | LIBERO-Goal task 8 (Franka Panda) | uv + Python 3.10; fake local fixtures; pinned Linux/amd64 CUDA image for RunPod | capability-scoped Gradio simulator frames | Doctor, 33 tests, fake rollout, protected CPU lifecycle, diagnostics, and exact closed-stdin LIBERO task reset passed 2026-08-24; interactive RTX PRO 4500 diagnosis validated CUDA/environment and drove wheel-asset hydration, tokenizer pinning, transient model staging, and tied-weight guards; real episode/proxy/cancellation remain blocked by HTTP 403 for the manually gated PaliGemma tokenizer |
