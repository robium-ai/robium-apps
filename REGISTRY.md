...
| --- | --- | --- | --- | --- | --- | --- |
| [indoor-navigation](indoor-navigation/) | Classical ROS navigation | ROS 2 Jazzy + Nav2 + slam_toolbox | Gazebo Harmonic; Waffle Pi in selectable House and Warehouse environments | Pixi/RoboStack (macOS arm64) + Docker | Native Gazebo + bundled Lichtblick + reusable Robot Control `.foxe` | Runtime validation only; automated tests intentionally removed |
