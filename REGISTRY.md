...
| --- | --- | --- | --- | --- | --- | --- |
| [indoor-navigation](indoor-navigation/) | Classical ROS navigation | ROS 2 Jazzy + Nav2 + slam_toolbox | Gazebo Harmonic (native GUI or headless) | Pixi/RoboStack (macOS arm64) + Docker | Native Gazebo + bundled Lichtblick | `make demo-native` verified; `make smoke` is the Docker pass bar |
