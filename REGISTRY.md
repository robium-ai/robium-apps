...
| [vla-pick-and-place](vla-pick-and-place/) | Language-conditioned VLA (experimental) | LeRobot 0.6.0 + SmolVLA 450M | MuJoCo 3.10 (SO-101) | uv + Python 3.12 (MPS) + HF Jobs (GPU train) | Rerun (+ gradio_rerun demo UI) | `./app doctor` + `make test` (60) + `make demo-smoke` (2026-08-17) |
