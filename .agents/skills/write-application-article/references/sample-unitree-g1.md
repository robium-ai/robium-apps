...
Concrete LeRobot source supplied by the user. Study the maintained-lab-note voice, numbered hardware journey, exact network facts, local tips, and simulation-to-hardware progression.

## Contents

- Setup and simulation
- Physical robot networking
...
---
title: "Unitree G1"
summary: "A complete LeRobot hardware guide covering simulation, robot networking, teleoperation, data collection, training, and inference."
slug: unitree-g1
sample: false
source_name: "LeRobot documentation"
source_url: "https://github.com/huggingface/lerobot/blob/main/docs/source/unitree_g1.mdx"
pattern: "Hardware setup → simulation → networking → teleoperation → training"
tags: [hardware guide, humanoid, Unitree G1]
...
> [!TIP]
> For now, pinocchio must be installed from conda-forge (not pip) to include the CasADi bindings needed for arm IK.
