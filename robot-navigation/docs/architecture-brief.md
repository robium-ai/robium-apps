# Architecture Brief — robot-navigation
...
- **Layout:** self-contained app at `robot-navigation/` at the repo root.
...
├── src/
│   └── robot_nav_bringup/            # the one app package
│       ├── launch/
...
├── app                               # repository-local lifecycle launcher
└── README.md
```
...
Movement plus Stop Robot; robot-navigation explicitly enables Maps,
...
drag/open; generated bundles stay untracked. `./app dashboard-extension` builds
