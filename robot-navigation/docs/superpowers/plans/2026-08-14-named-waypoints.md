...
**Files:**
- Create: `robot-navigation/src/robot_nav_bringup/robot_nav_bringup/waypoints.py`
- Create: `robot-navigation/tests/test_waypoints.py`
...
Run: `python3 -m unittest robot-navigation/tests/test_waypoints.py -v`

Expected: import failure because `robot_nav_bringup.waypoints` does not exist.
...
```bash
git add robot-navigation/src/robot_nav_bringup/robot_nav_bringup/waypoints.py robot-navigation/tests/test_waypoints.py
git commit -m "feat(robot-navigation): persist named waypoints"
```
...
- Modify: `robot-navigation/src/robot_nav_bringup/robot_nav_bringup/session_manager.py`
- Modify: `robot-navigation/src/robot_nav_bringup/package.xml`
- Modify: `robot-navigation/tests/test_session_processes.py`
- Modify: `robot-navigation/tests/test_waypoints.py`
...
Run: `python3 -m unittest robot-navigation/tests/test_session_processes.py robot-navigation/tests/test_waypoints.py -v`
...
```bash
python3 -m unittest robot-navigation/tests/test_session_processes.py robot-navigation/tests/test_waypoints.py -v
python3 -m py_compile robot-navigation/src/robot_nav_bringup/robot_nav_bringup/session_manager.py robot-navigation/src/robot_nav_bringup/robot_nav_bringup/waypoints.py
```
...
```bash
git add robot-navigation/src/robot_nav_bringup/robot_nav_bringup/session_processes.py robot-navigation/src/robot_nav_bringup/robot_nav_bringup/session_manager.py robot-navigation/src/robot_nav_bringup/robot_nav_bringup/waypoints.py robot-navigation/src/robot_nav_bringup/package.xml robot-navigation/tests/test_session_processes.py robot-navigation/tests/test_waypoints.py
git commit -m "feat(robot-navigation): serve waypoint actions"
```
...
```bash
docker run --rm robot-navigation:latest bash -lc 'cd /ws && . install/setup.bash && python3 -m unittest discover -s tests -p "test_*.py" -v'
...
First confirm no interactive mapping container is running. Then run `make -C robot-navigation smoke`. Expected: both known goals return `TaskResult.SUCCEEDED`, `PASS: all goals reached`, and exit 0. Do not exercise waypoint saving against the worktree's real map mount.
...
```bash
git add shared/lichtblick-robot-control robot-navigation/lichtblick/mapping-layout.json robot-navigation/tests/test_lichtblick_control_layout.py robot-navigation/docker/Dockerfile robot-navigation/Makefile robot-navigation/README.md REGISTRY.md
git commit -m "feat(robot-navigation): add named waypoint controls"
```
