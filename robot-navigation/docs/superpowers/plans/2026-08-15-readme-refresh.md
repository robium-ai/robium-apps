# Robot Navigation README Refresh Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Rewrite the robot-navigation README as a compact run guide for robotics developers.
...
**Interfaces:**
- Consumes: lifecycle commands from `robot-navigation/Makefile`, app metadata from `robot-navigation/robium-app.yaml`, and reusable panel guidance from `shared/lichtblick-dashboard/README.md`
- Produces: the primary clone, run, operate, and troubleshoot guide for robot-navigation
