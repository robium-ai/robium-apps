...
**Files:**
- Create: `robot-navigation/src/robot_nav_bringup/robot_nav_bringup/session_processes.py`
- Create: `robot-navigation/tests/test_session_processes.py`
...
**Files:**
- Create: `robot-navigation/src/robot_nav_bringup/robot_nav_bringup/session_manager.py`
- Create: `robot-navigation/src/robot_nav_bringup/launch/navigation_stack.launch.py`
- Modify: `robot-navigation/src/robot_nav_bringup/launch/mapping.launch.py`
- Modify: `robot-navigation/src/robot_nav_bringup/launch/sim.launch.py`
- Modify: `robot-navigation/src/robot_nav_bringup/setup.py`
...
- Modify: `robot-navigation/docs/superpowers/plans/2026-08-14-idle-sessions-and-simulation-worlds.md` (checkboxes only)
- Modify: `REGISTRY.md`
