...
class SessionProcesses:
    ...
    def __init__(self, process_factory, maps_root, initial_world='simple_house'):
    ...
    def _start_simulation(self):
        self._simulation = self._factory(
            'simulation',
            [
                'ros2', 'launch', 'robot_nav_bringup', 'sim.launch.py',
    ...
    def _navigation_command(mode, map_yaml=None):
        command = [
            'ros2', 'launch', 'robot_nav_bringup', 'navigation_stack.launch.py',
            f'mode:={mode}',
        ]
