...
def evaluate(
    ...
    # Before the base VLM download: a bad reference should cost a Hub listing,
    # not a minute of loading followed by an opaque resolution traceback.
    policy_path = resolve_checkpoint(str(policy_path))
